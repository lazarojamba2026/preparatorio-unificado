  ...
  },
{
  ...
  },
  {
    ...
    disciplinas: [
      ...
      ]}, { enunciado: "Qual é a classe gramatical da palavra 'rapidamente' em: 'Ele correu rapidamente'?", opcoes: ["Substantivo", "Adjetivo", "Advérbio", "Verbo"], correta: 2, explicacao: "Advérbio: modifica o verbo 'correu', indicando modo." }
, { enunciado: "Assinale a opção em que todas as palavras estão escritas corretamente:", opcoes: ["Exceção, benefício, através", "Exessão, benefisio, atraz", "Ecessão, benefício, atravez", "Exceção, beneficio, através"], correta: 0, explicacao: "As três palavras: Exceção, benefício e através estão corretas." }
, { enunciado: "Em 'Fui ao mercado', o 'ao' é a contração de:", opcoes: ["a + o", "a + a", "de + o", "em + o"], correta: 0, explicacao: "Fui a o mercado = ao mercado. Preposição 'a' + artigo 'o'." }
, { enunciado: "Qual o plural de 'cidadão'?", opcoes: ["cidadãos", "cidadões", "cidadãos", "cidadães"], correta: 2, explicacao: "Palavras terminadas em -ão: plural em -ãos. Cidadão -> cidadãos." }
, { enunciado: "Na frase 'Estudei para passar no teste', o termo 'para passar' é:", opcoes: ["Oração subordinada adjetiva", "Oração subordinada adverbial final", "Oração coordenada", "Oração subordinada substantiva"], correta: 1, explicacao: "Indica finalidade: 'para quê?' Passei para passar no teste." }
, { enunciado: "A palavra 'pátria' é acentuada porque:", opcoes: ["É oxítona terminada em a", "É paroxítona terminada em ditongo", "É proparoxítona", "É monossílaba tônica"], correta: 2, explicacao: "Pá-tria: proparoxítona. Todas as proparoxítonas são acentuadas." }
, { enunciado: "Escolha a opção com pronome de tratamento adequado para um Juiz:", opcoes: ["Vossa Senhoria", "Vossa Excelência", "Vossa Majestade", "Vossa Santidade"], correta: 1, explicacao: "Para Juiz, Deputado, Ministro usa-se 'Vossa Excelência'." }
, { enunciado: "Em 'água de coco', o termo 'de coco' classifica-se como:", opcoes: ["Adjunto adnominal", "Complemento nominal", "Objeto direto", "Aposto"], correta: 0, explicacao: "Adjunto adnominal: caracteriza o substantivo 'água'." }
, { enunciado: "Qual o sinônimo de 'efêmero'?", opcoes: ["Eterno", "Duradouro", "Passageiro", "Permanente"], correta: 2, explicacao: "Efêmero = que dura pouco tempo, passageiro." }
, { enunciado: "Assinale a frase com concordância nominal correta:", opcoes: ["É proibido entrada de estranhos.", "É proibida a entrada de estranhos.", "É proibidos a entrada de estranhos.", "É proibida entrada de estranhos."], correta: 1, explicacao: "Com artigo 'a', 'proibida' concorda com 'entrada'." }
, { enunciado: "A figura de linguagem em 'Ele é um leão na luta' é:", opcoes: ["Metáfora", "Comparação", "Personificação", "Onomatopeia"], correta: 0, explicacao: "Metáfora: comparação direta sem 'como'. Ele é = leão." }
, { enunciado: "Em 'Houve muitos problemas', o verbo 'haver' está:", opcoes: ["No plural porque 'problemas' está no plural", "No singular porque é impessoal", "No plural por concordância", "Errado"], correta: 1, explicacao: "Haver no sentido de 'existir' é impessoal e fica no singular: Houve." }
, { enunciado: "Qual palavra tem ditongo?", opcoes: ["Saúde", "País", "Caixa", "Saia"], correta: 2, explicacao: "Caixa = ai. Ditongo é encontro de vogal + semivogal na mesma sílaba." }
, { enunciado: "O oposto de 'altruísmo' é:", opcoes: ["Generosidade", "Solidariedade", "Egoísmo", "Empatia"], correta: 2, explicacao: "Altruísmo = pensar no outro. Oposto = egoísmo." }
, { enunciado: "Em 'Preciso de ajuda', a regência do verbo 'precisar' exige:", opcoes: ["a", "de", "com", "para"], correta: 1, explicacao: "O verbo precisar é transitivo indireto: precisar de algo." }
, { enunciado: "Assinale a alternativa correta quanto ao uso do hífen:", opcoes: ["anti-inflamatorio", "antiinflamatório", "anti-inflamatório", "anti inflamatório"], correta: 2, explicacao: "Prefixo 'anti' + palavra iniciada com vogal = hífen: anti-inflamatório." }
, { enunciado: "Na frase 'Gosto de ler livros', 'ler livros' é:", opcoes: ["Objeto direto", "Objeto indireto", "Sujeito oracional", "Predicativo"], correta: 2, explicacao: "É uma oração subordinada substantiva subjetiva que funciona como sujeito." }
, { enunciado: "Qual é o coletivo de 'abelhas'?", opcoes: ["Enxame", "Cardume", "Rebanho", "Alcateia"], correta: 0, explicacao: "Conjunto de abelhas = enxame." }
, { enunciado: "Em 'Vende-se casas', o correto é:", opcoes: ["Vende-se casas", "Vendem-se casas", "Vende-se casa", "Ambas estão corretas"], correta: 1, explicacao: "Com sujeito paciente plural, o verbo concorda: Vendem-se casas." }
, { enunciado: "A palavra 'tênis' é acentuada por ser:", opcoes: ["Oxítona terminada em i", "Paroxítona terminada em s", "Proparoxítona", "Monossílaba"], correta: 1, explicacao: "Tê-nis: paroxítona terminada em s. Paroxítonas terminadas em r,l,n,s,x,i,um são acentuadas." }
, { enunciado: "Na frase 'Embora chovesse, saímos', a oração 'Embora chovesse' é:", opcoes: ["Subordinada adverbial causal", "Subordinada adverbial concessiva", "Subordinada adverbial condicional", "Subordinada adverbial temporal"], correta: 1, explicacao: "Concessiva: indica fato que poderia impedir a ação principal, mas não impediu." }
, { enunciado: "Em 'Ele disse que viria', a oração 'que viria' é:", opcoes: ["Subordinada substantiva objetiva direta", "Subordinada substantiva subjetiva", "Subordinada adjetiva", "Coordenada"], correta: 0, explicacao: "Completa o sentido do verbo 'disse'. É objeto direto." }
, { enunciado: "A crase é obrigatória em:", opcoes: ["Vou a Roma", "Vou a pé", "Refiro-me a ela", "Cheguei a casa"], correta: 2, explicacao: "Verbo 'referir-se a' + pronome feminino 'ela' com artigo = à ela." }
, { enunciado: "Qual figura de linguagem em 'Milhões de vezes te liguei'?", opcoes: ["Hipérbole", "Eufemismo", "Ironia", "Metonímia"], correta: 0, explicacao: "Hipérbole: exagero intencional." }
, { enunciado: "Em 'É necessário que estudes', o 'que' é:", opcoes: ["Pronome relativo", "Conjunção integrante", "Advérbio", "Preposição"], correta: 1, explicacao: "Conjunção integrante: introduz oração subordinada substantiva." }
, { enunciado: "Assinale a frase correta:", opcoes: ["Houveram muitos acidentes", "Houve muitos acidentes", "Houveram-se muitos acidentes", "Houve-se muitos acidentes"], correta: 1, explicacao: "Haver = existir é impessoal. Só no singular: Houve." }
, { enunciado: "Em 'Prefiro café a chá', o 'a' é:", opcoes: ["Preposição", "Artigo", "Crase", "Conjunção"], correta: 0, explicacao: "Verbo preferir rege 'a': preferir A. Não há artigo depois." }
, { enunciado: "A palavra 'heroico' é:", opcoes: ["Paroxítona", "Oxítona", "Proparoxítona", "Hiato"], correta: 3, explicacao: "He-ro-i-co. Hiato: i + o em sílabas diferentes." }
, { enunciado: "Em 'Trata-se de um problema sério', o 'se' é:", opcoes: ["Partícula apassivadora", "Índice de indeterminação do sujeito", "Pronome reflexivo", "Conjunção"], correta: 0, explicacao: "Verbo transitivo direto + se = partícula apassivadora." }
, { enunciado: "Qual o antônimo de 'prolixo'?", opcoes: ["Extenso", "Sucinto", "Complexo", "Detalhado"], correta: 1, explicacao: "Prolixo = que fala/escreve demais. Oposto = sucinto." }
    ]
  },
  {
    id: "saude",
